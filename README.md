...
- Android APK attached to the GitHub Release

The Android APK generated by the default workflow is suitable for internal testing. Production signing and Play Store/AAB publishing require adding signing secrets and extending `.github/workflows/release.yml`.
